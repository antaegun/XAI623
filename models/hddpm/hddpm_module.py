...
from .components.gaussian_diffusion import (
    GaussianDiffusion,
    ModelMeanType,
    ModelVarType,
    LossType,
...
from .components.resample import (
    create_named_schedule_sampler,
    LossAwareSampler,
)
from .components.unet import UNetModel


class HDDPM(torch.nn.Module):
    """Improved DDPM Model"""
    ...
    def __init__(
        ...
        self.ema_model = EMA(model=self.net, decay=self.ema_decay)
